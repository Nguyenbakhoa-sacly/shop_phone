      ...
      <section className='flex justify-center items-center'>
        <form className="form_container">
          <div className="logo_container">
            <BiSolidUserCircle className='w-full h-auto text-violet-700 ' />
          </div>
          ...
          <Link to='/forget' className='forget_btn'>
            Forget password?
          </Link>
          <button onClick={handleSign} title="Sign In" type="submit" className="sign-in_btn">
            <span>Sign In</span>
          </button>
          ...
          <button
            ...
            title="Sign In"
            type="submit"
            className="sign-in_fac">
            <FaFacebookF className='text-blue-600 text-4xl' />
            <span>Sign In with Facebook</span>
          </button>
          <p
            className="note">don't have account?
